...
library LibEntity {
    ...
    event TokenSaleStarted(bytes32 indexed entityId, uint256 offerId, bytes32 tokenSymbol);
    ...
    function _startTokenSale(
        ...
        emit TokenSaleStarted(_entityId, offerId, s.objectTokenSymbol[_entityId]);
    }
