...
contract MarketFacet is IMarketFacet, Modifiers, ReentrancyGuard {
     ...
     */
    function cancelOffer(uint256 _offerId) external notLocked(IMarketFacet.cancelOffer.selector) nonReentrant {
    ...
    function executeLimitOffer(
        ...
        external
        notLocked(IMarketFacet.executeLimitOffer.selector)
        nonReentrant
        returns (
            uint256 offerId_,
