...
contract T04MarketTest is D03ProtocolDefaults, MockAccounts {
    ...
    function testMarketFacet0008_IM24522() public {
        ...
        vm.startPrank(sm.addr);
        nayms.enableEntityTokenization(acc1.entityId, "ptE1", "pToken-E1");
    ...
    function testMarketFacet0009AM() public {
        ...
        vm.startPrank(sm.addr);
        nayms.enableEntityTokenization(acc1.entityId, "E1", "E1-pToken");
    ...
    function testMarketFacet0011() public {
        ...
        nayms.enableEntityTokenization(acc1.entityId, "DemoEntity1", "DemoEntity1");
        ...
        nayms.enableEntityTokenization(acc2.entityId, "DemoEntity2", "DemoEntity2");
    ...
    function fundEntityUsdc(NaymsAccount memory acc, uint256 amount) private {
        vm.startPrank(acc.addr);
        writeTokenBalance(acc.addr, naymsAddress, usdcAddress, amount);
