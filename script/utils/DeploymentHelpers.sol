...
contract DeploymentHelpers is Test {
    ...
    function findAndReplace(bytes memory res, string memory find) public pure returns (string[] memory parts) {
    ...
    function findAndReplaceToString(bytes memory res, string memory find) public pure returns (string memory whole) {
        string memory start = string(res);
        strings.slice memory s = start.toSlice();
        string memory d = find;
        strings.slice memory delim = d.toSlice();
